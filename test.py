...
if selected == "Suggest Cars":
    ...
    price_choice = st.sidebar.slider('Select a price range (in Lakhs)',0,7, (0, 250))
    ...
    df.drop(df.columns.difference(['Make','Ex-Showroom_Price','Fuel_Type','City_Mileage','Model']), 1, inplace=True)
