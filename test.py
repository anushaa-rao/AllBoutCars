...
if selected == "Suggest Cars":
    ...
    df = pd.read_csv("https://github.com/anushaa-rao/Check/blob/main/cars_engage_2022.csv")
...
if selected == "Electric vs Conventional Car":
    ...
    nor_com=pd.read_csv("https://github.com/anushaa-rao/Check/blob/main/cars_engage_2022.csv")
    #ev_com=pd.read_csv(r"C:\Users\Anusha\Desktop\project\ElectricCar.csv")
    ev_com=pd.read_csv("https://github.com/anushaa-rao/Check/blob/main/ElectricCar.csv")
